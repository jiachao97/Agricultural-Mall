...
function e(n, t, o) {
	...
	1: [function(e) {
		...
		function r() {
			console.log("Permission has been granted by the user"), s("浣犺鎹忎唬鐮佸凡缁忓鍒跺埌鍓创鏉匡紝绮樺幓鍚� ^_^")
		}
		function a() {
		...
		x.auth = function() {
			var e = h(".auth"),
				n = e.find("#username"),
				t = e.find("#user-avatar");
			n.on("blur", function() {
				var e = l(h(this).val());
				t.attr("src", "http://www.gravatar.com/avatar/" + e + "?d=mm&s=144")
			})
		}, x.externalLink = function() {
			var e = h(".doc-content"),
				n = e.find('a[href^="http://"], a[href^="https://"]').not(".doc-example a");
			n.addClass("external-link").attr("target", "_blank")
		}, x.checkLogin = function() {
			var e = c && c.enabled,
				n = h("#amz-header"),
				t = n.find(".nav-profile.need-check"),
				o = t.find("img"),
				i = "_amui_login_status",
				r = (new Date).getTime();
			if (e) {
				var a = c.get(i);
				if (a) {
					if (p.location.search.indexOf("logout") > -1) return c.remove(i), void t.hide();
					if (r - a.lastCheck < 36e5) return o.attr("src", a.avatar), void t.show().addClass("am-animation-fade");
					c.remove(i)
				}
			}
			h.getJSON("/api/user", function(n) {
				n.loggedIn ? (t.show(), o.attr("src", n.avatar), n.lastCheck = (new Date).getTime(), e && c.set(i, n)) : t.hide()
			})
		}, x.zeroClip = function() {
			if (window.ZeroClipboard) {
				...
				var e = '<div class="doc-actions"><div class="doc-act-inner"><span class="doc-act-clip am-icon-copy"> Copy</span></div></div>',
					n = '<div class="doc-actions"><div class="doc-act-inner"><span class="doc-act-newwin am-icon-file-code-o"> New Win</span><span class="doc-act-clip am-icon-copy"> Copy</span></div></div>';
				h(".doc-code").each(function() {
					var t = h(this),
						o = t.prev();
					o.hasClass("doc-example") ? o.before(o.attr("data-url") ? n : e) : t.before(e)
				}), h(".doc-act-newwin").on("click", function() {
					var e = h(this).parent().parent(".doc-actions").next(".doc-example");
					e.length && e.attr("data-url") && window.open(e.attr("data-url"), "", "width=320px, height=480px, centerscreen=yes")
				});
				var t = new ZeroClipboard(h(".doc-act-clip"));
				t.on("ready", function() {
					t.on("copy", function(e) {
						var n = h(e.target).parent().parent().next(),
							t = n.is(".doc-code") ? n : n.next(".doc-code");
						e.clipboardData.setData("text/plain", t.text())
					})
				}), t.on("aftercopy", function(e) {
					u.needsPermission ? u.requestPermission(r, a) : s("浣犺鎹忎唬鐮佸凡缁忓鍒跺埌鍓创鏉匡紝绮樺幓鍚� ^_^"), console && console.log("Copied text to clipboard: " + e.data["text/plain"])
				}), t.on("error", function(e) {
					u.needsPermission ? u.requestPermission(r, a) : s("Something wrong :-(\n" + e.name)
				})
			}
		}, x.toolbar = function() {
			function e() {
				t.scrollTop() > 10 ? i.addClass("am-active") : i.removeClass("am-active")
			}
			function n() {
				o.css(t.width() > 1110 ? {
					right: (t.width() - 1110) / 2
				} : {
					right: "10px"
				})
			}
			...
			i.length && (i.on("click", function(e) {
				return e.preventDefault(), v ? (h("html, body").animate({
					scrollTop: 0
				}, 500), !1) : void h(p).smoothScroll(0)
			}), e(), n(), t.on("scroll", h.AMUI.utils.debounce(e, 100)), t.on("resize", h.AMUI.utils.debounce(n, 100)))
		}, x.standaloneMode = function() {
			window.navigator.standalone && h(document).on("click", "a", function(e) {
				var n = h(this).attr("href");
				n && (n.indexOf("http") || ~n.indexOf(location.host)) && (e.preventDefault(), location.href = n)
			})
		}, x.pageChange = function() {
			var e = h.AMUI.support.animation,
				n = h("body");
			e && (h(document).on("click", "a", function(t) {
				var o = h(this).attr("href");
				o && (o.indexOf("http") || ~o.indexOf(location.host)) && (t.preventDefault(), n.addClass("doc-slide-out"), n.one(e.end, function() {
					location.href = o
				}))
			}), n.addClass("doc-slide-in"), n.one(e.end, function() {
				n.removeClass("doc-slide-in")
			}))
		}, x.getIssues = function() {
			var e = "https://api.github.com/repos/allmobilize/amazeui/issues?state=all&labels=",
				n = h("#amz-main"),
				t = n.attr("data-tag"),
				...
				r = o.text() || "",
				a = f && f.compile(r);
			t && a && h.getJSON(e + t, function(e) {
				e && e.length && i.html(a(e))
			})
		}, x.sticky = function() {
			function e() {
				var e = h(".amz-footer"),
					n = e[h.fn.outerHeight ? "outerHeight" : "height"](),
					t = h(p).height() - 20 - n;
				i.hasClass("am-sticky") ? (s.css({
					"max-height": t
				}), i.css({
					"max-height": t
				})) : (s.css({
					...
					"max-height": ""
				})), t > s.height() ? r.removeClass("am-active") : r.addClass("am-active"), r.css({
					top: s.height() / 2
				})
			}
			function n() {
				var e = "am-disabled";
				0 === s.scrollTop() ? a.eq(0).addClass(e) : a.eq(0).removeClass(e)
			}
			function t(e, n) {
				e = e || "up", n = n || 100;
				var t = ("up" === e ? -n : n) + s.scrollTop();
				s.scrollTop(t)
			}
			var o = navigator.userAgent.toLowerCase();
			if (!(/msie/.test(o) && parseFloat((o.match(/.*(?:rv|ie)[\/: ](.+?)([ \);]|$)/) || [])[1]) < 10)) {
				var i = h("#amz-offcanvas"),
					r = i.find(".amz-pager"),
					a = r.find("a"),
					s = i.find(".amz-sidebar");
				i.sticky({
					top: 10,
					bottom: function() {
						return h(".amz-footer").height() + 25
					},
					media: 641
				}), e(), setTimeout(e, 119), h(p).on("scroll resize", h.AMUI.utils.debounce(e, 10)), r.on("click", "a", function(e) {
					if (e.preventDefault(), !h(this).hasClass("am-disabled")) {
						var n = h(this).data("rel"),
							t = s.scrollTop(),
							o = 200;
						s.smoothScroll("scrollUp" === n ? {
							position: t - o
						} : {
							position: t + o
						})
					}
				}), s.on("scroll", h.AMUI.utils.debounce(n, 50)), s.on("mousewheel", function(e) {
					e.preventDefault();
					var n = e.wheelDelta < 0 ? "down" : "up";
					t(n)
				}).on("DOMMouseScroll", function(e) {
					e.preventDefault(), t(e.detail > 0 ? "down" : "up")
				})
			}
		}, x.docToc = function() {
			var e = h(".doc-toc-bd > .md-toc"),
				n = e.find(">li").has(">ul");
			n.addClass("am-parent"), n.on("mouseenter", function() {
				var e = h(this).children("ul");
				e.collapse("open"), h(this).addClass("am-open")
			}), e.find("a").on("click", function(e) {
				e.preventDefault();
				var n = decodeURIComponent(h(this).attr("href")),
					t = h(n);
				t.length && h(p).smoothScroll({
					position: t.offset().top
				})
			})
		}, x.init = function() {
			this.auth(), this.externalLink(), this.checkLogin(), this.zeroClip(), this.toolbar(), this.standaloneMode(), this.getIssues(), this.docToc(), this.sticky()
		}, h(function() {
			var e = h("#amz-main").find(".doc-content"),
				n = e.find(".doc-toc");
			if (n.next().is("h1") && e.find("hr").first().after(n), m && b.version < 9) return !1;
			x.init(), h(".amz-social [data-am-modal]").on("click", function(e) {
				e.preventDefault()
			});
	...
	2: [function() {
		...
		function(e) {
			...
			function f(e, n) {
				...
				return o = c(r.concat(l(n)), 512 + 8 * n.length), u(c(a.concat(o), 640))
			}
			function p(e) {
			...
			function g(e, n, t) {
				return n ? t ? v(n, e) : w(n, e) : t ? b(e) : m(e)
			}
	...
	3: [function(e, n) {
		(function(e) {
			...
			function r(e, n) {
				for (var t = 0, o = e.length; o > t && n.call(e, e[t], t) !== !1; t++);
			}
			function a(e) {
				...
				n = h.exec(e), i = n[1];
				var s = n[1].split(".");
				return "undefined" == typeof r && (r = i), s[0] = parseInt(s[0], 10) - 4, t = s.join("."), "undefined" == typeof o && (o = t), {
					browserVersion: r,
					browserMode: i,
					engineVersion: o,
					engineMode: t,
			...
			function s(e) {
				if (l) try {
					var n = l.twGetRunPath.toLowerCase(),
						t = l.twGetSecurityID(p),
						o = l.twGetVersion(t);
			...
			function c(e, n, r) {
				...
				if (a === !0) return s;
				if ("[object String]" === c) {
					if (-1 !== r.indexOf(a)) return s
				} else {
					if (o(a)) return a.hasOwnProperty("version") && (s.version = a.version), s;
					if (a.exec) {
						var u = a.exec(r);
						if (u) return s.version = u.length >= 2 && u[1] ? u[1].replace(/_/g, ".") : f, s
					}
				}
			}
			function u(e, n, t, o) {
				...
				}), t.call(o, i.name, i.version)
			}
			var l, d = {},
				f = "-1",
				p = this,
				h = /\b(?:msie |ie |trident\/[0-9].*rv[ :])([0-9.]+)/,
				b = [
					["nokia", function(e) {
				...
				w = [
					...
					["liebao", function(e) {
						...
						var n;
						try {
							l && l.LiebaoGetVersion && (n = l.LiebaoGetVersion())
						} catch (t) {}
						return {
							version: n || f
						}
				...
				y = function(e) {
					...
					var t = a(e);
					return u(e, v, function(e, o) {
						var i = o;
						t && (o = t.engineVersion || t.engineMode, i = t.engineMode);
						var r = parseFloat(o);
						n.engine = {
							name: e,
							version: r,
					...
					}, n), u(e, w, function(e, o) {
						var i = o;
						t && ("ie" === e && (o = t.browserVersion), i = t.browserMode);
						var r = parseFloat(o);
						n.browser = {
							name: e,
							version: r,
			...
			if ("object" == typeof e && "[object process]" === e.toString()) {
				var x = n.require("./morerule");
				[].unshift.apply(b, x.DEVICES || []), [].unshift.apply(m, x.OS || []), [].unshift.apply(w, x.BROWSER || []), [].unshift.apply(v, x.ENGINE || [])
			} else {
				var k = navigator.userAgent || "",
					C = navigator.appVersion || "",
					z = navigator.vendor || "";
				l = p.external, d = y(k + " " + C + " " + z), p.detector = d
			}
			d.parse = y, n.exports = d
		}).call(this, e("oMfpAn"))
	}, {
		oMfpAn: 4
	}],
	4: [function(e, n) {
		...
		}(), o.title = "browser", o.browser = !0, o.env = {}, o.argv = [], o.on = t, o.addListener = t, o.once = t, o.off = t, o.removeListener = t, o.removeAllListeners = t, o.emit = t, o.binding = function() {
	...
	5: [function(e, n, t) {
		...
		function(e, o) {
			...
			"function" == typeof define && define.amd ? define("notify", [], function() {
				return o(e, document)
			}) : "object" == typeof t ? n.exports = o(e, document) : e.Notify = o(e, document)
		}(window, function(e) {
			"use strict";
			...
			function t(e, o) {
				...
				if (this.title = e, this.options = {
					...
					timeout: null
				}, this.permission = null, t.isSupported && "object" == typeof o) {
					for (var i in o) o.hasOwnProperty(i) && (this.options[i] = o[i]);
			...
			return t.isSupported = "Notification" in e, t.needsPermission = !(t.isSupported && "granted" === Notification.permission), t.requestPermission = function(o, i) {
		...
		function(e) {
			...
			function o(e) {
				return function() {
					...
					n.unshift(r), l.appendChild(r), r.addBehavior("#default#userData"), r.load(c);
					var t = e.apply(a, n);
					return l.removeChild(r), t
				}
			}
			function i(e) {
			...
			var r, a = {},
				...
				c = "localStorage",
				u = "script";
			if (a.disabled = !1, a.set = function() {}, a.get = function() {}, a.remove = function() {}, a.clear = function() {}, a.transact = function(e, n, t) {
				var o = a.get(e);
				null == t && (t = n, n = null), "undefined" == typeof o && (o = n || {}), t(o), a.set(e, o)
			...
			}, t()) r = e[c], a.set = function(e, n) {
				return void 0 === n ? a.remove(e) : (r.setItem(e, a.serialize(n)), n)
			}, a.get = function(e) {
				...
				var l, d;
				try {
					d = new ActiveXObject("htmlfile"), d.open(), d.write("<" + u + ">document.w=window</" + u + '><iframe src="/favicon.ico"></iframe>'), d.close(), l = d.w.frames[0].document, r = l.createElement("div")
				} catch (f) {
					r = s.createElement("div"), l = s.body
				}
				var p = new RegExp("[!\"#$%&'()*+,/\\\\:;<=>?@[\\]^`{|}~]", "g");
				a.set = o(function(e, n, t) {
					return n = i(n), void 0 === t ? a.remove(n) : (e.setAttribute(n, a.serialize(t)), e.save(c), t)
				}), a.get = o(function(e, n) {
					return n = i(n), a.deserialize(e.getAttribute(n))
				}), a.remove = o(function(e, n) {
					n = i(n), e.removeAttribute(n), e.save(c)
				}), a.clear = o(function(e) {
					var n = e.XMLDocument.documentElement.attributes;
					e.load(c);
					for (var t, o = 0; t = n[o]; o++) e.removeAttribute(t.name);
					e.save(c)
				}), a.getAll = function() {
					var e = {};
					return a.forEach(function(n, t) {
				...
				}, a.forEach = o(function(e, n) {
					for (var t, o = e.XMLDocument.documentElement.attributes, i = 0; t = o[i]; ++i) n(t.name, a.deserialize(e.getAttribute(t.name)))
				})
			}
			try {
				var h = "__storejs__";
			...
			a.enabled = !a.disabled, "undefined" != typeof n && n.exports && this.module !== n ? n.exports = a : "function" == typeof define && define.amd ? define(a) : e.store = a
